...
echo "Use Bane to autogenerate AppArmor Profile for Nginx sample" && bane /root/sample/bin/sample.toml
echo "Validate autogenerated  profile: " && apparmor_parser -r -W /etc/apparmor.d/containers//apparmor-nginx-profile
